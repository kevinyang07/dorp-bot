...
class askwolfram(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.wolfram_client = wolframalpha.Client(wolfram)
    ...
    async def ask(self, ctx, *, query):
        ...
        computing_message = await ctx.send(":wolf: Searching for '" + query + "' :computer: :thought_balloon: ...")
    ...
    @commands.guild_only()
    async def askshort(self, ctx, *, query):
        """
